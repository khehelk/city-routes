...
import {registrationReq} from "../api/AuthApi.ts";
...
const Registration = () => {
    ...
    const registration = () => {
        ...
        registrationReq({email: email, password: password})
            .then(res => {
    ...
    return (
        <div className="flex flex-col justify-center">
            ...
            <div className="m-2 flex flex-col justify-center">
                <h1 className="p-2 font-bold border flex justify-center rounded-t-2xl">Регистрация</h1>
